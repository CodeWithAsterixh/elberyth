<script lang="ts" setup>
    ...
    const props = defineProps(['productName','price','src'])
</script>

<template>
    <div class="w-full flex flex-col gap-2">
        <span class="w-full h-52 overflow-hidden relative sm:h-80 group isolate bg-secondary flex items-center justify-center">
